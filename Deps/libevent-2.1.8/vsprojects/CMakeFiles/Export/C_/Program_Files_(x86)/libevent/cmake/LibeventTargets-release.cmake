...
set_target_properties(event PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "C:/Program Files (x86)/libevent/lib/event.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS event )
list(APPEND _IMPORT_CHECK_FILES_FOR_event "C:/Program Files (x86)/libevent/lib/event.lib" )
...
set_target_properties(event_core PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "C:/Program Files (x86)/libevent/lib/event_core.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS event_core )
list(APPEND _IMPORT_CHECK_FILES_FOR_event_core "C:/Program Files (x86)/libevent/lib/event_core.lib" )
...
set_target_properties(event_extra PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "C:/Program Files (x86)/libevent/lib/event_extra.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS event_extra )
list(APPEND _IMPORT_CHECK_FILES_FOR_event_extra "C:/Program Files (x86)/libevent/lib/event_extra.lib" )
