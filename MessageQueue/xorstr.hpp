...
namespace jm {
	...
	xor_string<detail::tstring_<Tstr().value[StringIndices]...>, detail::key_list<detail::key8<KeyIndices>()...>>
	make_xorstr(Tstr, std::index_sequence<StringIndices...>, std::index_sequence<KeyIndices...>)
    {
        return {};
    }
